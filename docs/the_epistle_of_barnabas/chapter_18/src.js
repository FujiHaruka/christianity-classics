	...
	module.exports = [
		{
			...
			"sentences": [
				...
				{
					"id": 2,
					"en": "But let us now pass to another sort of knowledge and doctrine.",
					"ja": "しかし、私たちは今、知識や教義の別のソートに渡すことができます。"
				},
				{
					"id": 3,
					"en": " There are two ways of doctrine and authority, the one of light, and the other of darkness.",
					"ja": "闇の2教義と権威の方法、光の1、およびその他があります。"
				},
				{
					"id": 4,
					"en": " But there is a great difference between these two ways.",
					"ja": "しかし、これら二つの方法の間には大きな違いがあります。"
				},
				{
					"id": 5,
					"en": " For over one are stationed the light-bringing angels of God, but over the other the angels 2 Corinthians 12:7 of Satan.",
					"ja": "サタンの7：2コリント12を1オーバーのために神の光もたらす天使に駐留しているが、他の上の天使たち。"
				},
				{
					"id": 6,
					"en": " And He indeed (i.",
				...
				{
					"id": 8,
					"en": ", God) is Lord for ever and ever, but he (i.",
					"ja": "、神は）永遠のために主であるが、彼（私。"
				},
				{
					"id": 9,
					"en": "e.",
				...
				{
					"id": 10,
					"en": ", Satan) is prince of the time of iniquity.",
					"ja": "、サタンは）不義の時間の王子です。"
				}
			]
		}
